...
As of now there are 2 hardware revisions of ui_to_usb:
  ...
  1. __Rev: -__: based on a FTDI FT232H, which doesn't have programmable firmware and makes the host PC suffer from performance issues when polling the rotary encoder at high speeds.
  2. __Rev: 1__: based on a CH32V203 USB capable microcontroller. This is the firmware package for this board.

## USB interface
The USB support is based on the excellent TinyUSB library. It implements the following endpoints, defined in [usb_interface.c](src/usb_interface.c):
  ...
  1. EP 0 (Control): Send commands and return results
     ...
     * 0x32: CMD_OLED_INVERTED, set OLED inverted shades on or off. Can be used to minimize burn in.
